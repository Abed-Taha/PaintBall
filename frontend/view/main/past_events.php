...
<div class="relative z-1 w-100">
    <h3 class="text-center c-brown title">Our Past Events ! </h3>
    <div class="events-container flex flex-wrap  m-center events-scroll" data-speed="2.2">
        <?php foreach ($events as $event): ?>
            <div class="events-item ">
                ...
                <div>
                    <p>Start-date : <?= $event["finish_date"] ?></p>
